...
$\rho_f = (0{,}991 \pm 0{,}012)\,\text{g/cm}^3$, con un error porcentual
de $0{,}86\%$ y una incertidumbre relativa unitaria de $1{,}17\%$,
indican que el intervalo experimental
$0{,}979 \leq \rho_f \leq 1{,}003\,\text{g/cm}^3$ contiene al valor de
...
punto de referencia de la balanza, en efectos de tensión superficial
en el menisco al momento del primer contacto de la varilla con el
agua, o en la presencia de la cinta de tirro utilizada para marcar las
longitudes sumergidas, la cual pudo aportar un empuje adicional no
contemplado por el modelo.
...
reacción humana al operar el cronómetro (del orden de
$0{,}2$--$0{,}3\,\text{s}$) adquiere un peso proporcionalmente mayor
sobre tiempos de vaciado más cortos, pudiendo enmascarar parcialmente
el sesgo sistemático. En la misma línea, el ajuste potencial
